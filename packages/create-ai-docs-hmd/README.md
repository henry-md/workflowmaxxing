...
Create the files in a visible `test-output` folder:

```sh
npm --prefix packages/create-ai-docs-hmd run test:scaffold
```

Clean up:

```sh
npm --prefix packages/create-ai-docs-hmd run clean:scaffold
```
